const I18N = {
  pt: {
    ...
    hero_title: "Como o Nero Atlas decide o que importa.",
    ...
    balance_text: "Se uma fonte domina excessivamente o topo, Nero Atlas aplica ajuste leve para manter diversidade entre Reddit e GitHub.",
  ...
  en: {
    ...
    hero_title: "How Nero Atlas decides what matters.",
    ...
    balance_text: "If one source dominates the top too much, Nero Atlas applies a light adjustment to keep diversity between Reddit and GitHub.",
